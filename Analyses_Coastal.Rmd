...
data.frame(corr_caserate = sort(cormat[,(ncol(x)-1)], decreasing = T))#correlation of confounders with caserate
data.frame(corr_deathrate = sort(cormat[,ncol(x)], decreasing = T))#correlation of confounders with deatherate
